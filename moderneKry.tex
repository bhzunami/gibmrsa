...
Die immer besseren, bzw. schnelleren Computer machen die klassische Kryptographie sehr unsicher, da der Schlüssel durch Brute-Force-Angriffe\footnote{Brute-Force nennt man ein Vorgehen, wenn man ein Passwort durch ausprobieren knackt.} schnell gefunden werden kann.\\
...
1985 entwickelten drei Mathematiker/Innen das \textbf{Zero-Knowlede-Verfahren}. Das Zero-Knowlede-Verfahren baut auf die Public Key-Kryptographie auf. Mit diesem Verfahren ist es möglich, mit jemanden über ein Geheimniss kommuniziere, ohne dass dieser etwas über das eigene Geheimnis erfährt. Der wesentliche Unterschied liegt im Protokol.
%
...
Auch hat die Geschichte gezeigt, dass bis heute viele Verschlüsselungsalgorithmus gebrochen werden konnte. \cite{chicago}\textit{(siehe Kryptographie, Kapitel 2.3)}.\\
%
...
%
Das Wichtigste bei der asymmetrischen Verschlüsselung ist, dass beim Entschlüsseln wieder der \textbf{gleiche} Text reproduziert wird, auch wenn zun Ver- und Entschlüsseln zwei unterschiedliche Schlüssel verwendet wurden.\\
